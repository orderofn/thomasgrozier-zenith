  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled ? "bg-background/98 backdrop-blur-xl border-b border-border shadow-md" : "bg-background/80 backdrop-blur-sm"
      }`}
    >
        ...
        <div className="flex items-center justify-between h-20">
          <div className="flex-shrink-0">
            <a href="#home" className="block">
              <img src={logo} alt="Thomas Grozier & Son" className="h-14 w-auto" />
            </a>
          </div>
